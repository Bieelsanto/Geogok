...
2. Para que o Login do _Google Play_ se dispare em auto-run, o recurso equivalente do ecossistema do celular deve já estar conectado de segundo plano nas variáveis do smartphone correspondente.
...
**Quando** não tiver nenhum apelido na respectiva tabela do banco de usuários atrelado ao _token_ retornado,
