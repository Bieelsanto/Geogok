...
Como usuário logado, quero acessar um menu principal com modos de jogo (Bandeiras, Mapas, Quiz, Customizada) e utilizar minha foto de perfil para abrir opções de estatísticas, conquistas e configurações, para utilizar o ecossistema do app sem me perder na navegação.
...
| :--- | :--- | :--- |
| **Foto do Perfil** | Imagem | Exibe o avatar. Ao clicar, abre um menu flutuante (dropdown) contendo opções extras. |
| **Dropdown: Estatísticas** | Link | Localizado no dropdown, direciona o usuário para um dashboard contendo estatísticas gerais do jogador. |
| **Dropdown: Conquistas** | Link | Localizado no dropdown, encaminha para os relatórios de uso e conquistas do jogador. |
| **Dropdown: Configurações** | Link | Localizado no dropdown, abre a tela para ajustes gerais do App (tema, idiomas e afins). |
| **Botão: Bandeiras** | Botão / Link | Levará ao menu de opções de jogos focados no conhecimento de bandeiras. |
| **Botão: Mapas** | Botão / Link | Levará ao menu de opções de jogos envolvendo desafios de conhecimento de mapas geográficos. |
| **Botão: Quiz** | Botão / Link | Levará ao menu com as opções de quizzes de perguntas e respostas. |
| **Botão: Customizada** | Botão / Link | Levará ao menu de jogos customizados já salvos ou à opção de criar um novo modo de jogo. |
...
**Então** um menu flutuante (dropdown) será expandido exibindo os atalhos para as telas de "Estatísticas", "Conquistas" e "Configurações".
